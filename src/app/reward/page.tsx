        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <section className="col-span-1  bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="mt-4">
              ...
              <p className="t text-gray-300">Level: <span className="font-semibold text-orange-400">5</span></p>
              <p className="t text-gray-300">Total Points: <span className="font-semibold text-orange-400">1250</span></p>
            </div>
            {/* Progress Tracker */}
            <div className="mt-6">
              <h3 className="text-xl font-semibold text-blue-400">Progress Tracker</h3>
              <div className="mt-4">
                <div className="t text-gray-300">Next Level: 1500 Points</div>
          ...
          <section className="col-span-1 bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="mt-4 space-y-4">
              <div className="p-4  bg-gray-600 rounded-lg shadow-sm">
              ...
              <div className="p-4 b bg-gray-600 rounded-lg shadow-sm">
