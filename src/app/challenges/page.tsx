...
export default function ChallengesPage() {
  return (
    <div className="min-h-screen px-6 py-12  bg-gray-950  text-gray-200">
      ...
      <div className="mt-16 max-w-7xl mx-auto">
        <h2 className="text-2xl font-bold mb-6 text-center  text-gray-100">Featured Challenges</h2>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {[ 
            ...
            <div key={index} className="bg-gray-900  p-6 rounded-lg shadow-md hover:shadow-xl shadow-slate-200">
              <Image
                src={challenge.img}
                alt={challenge.title}
                width={400}
              ...
              <p className=" text-gray-300">Level: {challenge.level}</p>
      ...
      <div className="mt-16 text-center max-w-7xl mx-auto">
        <h2 className="text-2xl font-bold mb-6  text-gray-100">Take the First Step</h2>
